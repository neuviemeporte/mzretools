...
void usage() {
    ...
    str << "mzptr v" << VERSION << endl
        ...
        << "Results will be written to standard output; these should be reviewed and changed to references to variables" << endl
...
int main(int argc, char *argv[]) {
    ...
    for (int aidx = 1; aidx < argc; ++aidx) {
        ...
        else if (exePath.empty()) refExePath = arg;
        else if (mapPath.empty()) refMapPath = arg;
