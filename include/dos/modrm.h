...
enum ModRM : Byte {
    ...
    // GRP
    MODRM_GRP1_ADD   = 0b000000, MODRM_GRP2_ROL = MODRM_GRP1_ADD, MODRM_GRP3a_TEST = MODRM_GRP1_ADD, MODRM_GRP3b_TEST = MODRM_GRP1_ADD, MODRM_GRP4_INC = MODRM_GRP1_ADD, MODRM_GRP5_INC     = MODRM_GRP1_ADD,
    MODRM_GRP1_OR    = 0b001000, MODRM_GRP2_ROR = MODRM_GRP1_OR,                                                                        MODRM_GRP4_DEC = MODRM_GRP1_OR,  MODRM_GRP5_DEC     = MODRM_GRP1_OR ,
    MODRM_GRP1_ADC   = 0b010000, MODRM_GRP2_RCL = MODRM_GRP1_ADC, MODRM_GRP3a_NOT  = MODRM_GRP1_ADC, MODRM_GRP3b_NOT  = MODRM_GRP1_ADC,                                  MODRM_GRP5_CALL    = MODRM_GRP1_ADC,
    MODRM_GRP1_SBB   = 0b011000, MODRM_GRP2_RCR = MODRM_GRP1_SBB, MODRM_GRP3a_NEG  = MODRM_GRP1_SBB, MODRM_GRP3b_NEG  = MODRM_GRP1_SBB,                                  MODRM_GRP5_CALL_Mp = MODRM_GRP1_SBB,
    MODRM_GRP1_AND   = 0b100000, MODRM_GRP2_SHL = MODRM_GRP1_AND, MODRM_GRP3a_MUL  = MODRM_GRP1_AND, MODRM_GRP3b_MUL  = MODRM_GRP1_AND,                                  MODRM_GRP5_JMP     = MODRM_GRP1_AND,
    MODRM_GRP1_SUB   = 0b101000, MODRM_GRP2_SHR = MODRM_GRP1_SUB, MODRM_GRP3a_IMUL = MODRM_GRP1_SUB, MODRM_GRP3b_IMUL = MODRM_GRP1_SUB,                                  MODRM_GRP5_JMP_Mp  = MODRM_GRP1_SUB,
    MODRM_GRP1_XOR   = 0b110000,                                  MODRM_GRP3a_DIV  = MODRM_GRP1_XOR, MODRM_GRP3b_DIV  = MODRM_GRP1_XOR,                                  MODRM_GRP5_PUSH    = MODRM_GRP1_XOR,
    MODRM_GRP1_CMP   = 0b111000, MODRM_GRP2_SAR = MODRM_GRP1_CMP, MODRM_GRP3a_IDIV = MODRM_GRP1_CMP, MODRM_GRP3b_IDIV = MODRM_GRP1_CMP,
